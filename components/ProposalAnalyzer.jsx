...
const AnimatedScoreBar = ({ score }) => {
  ...
  const color = score >= 8 ? "bg-primaryColor-400" : score >= 5 ? "bg-primaryColor-600" : "bg-primaryColor-800";
...
export default function ProposalAnalyzer() {
  ...
  const scoreColor = (score) => {
    if (score >= 8) return "text-primaryColor-400";
    if (score >= 5) return "text-primaryColor-600";
    return "text-primaryColor-800";
  };
    ...
    <div className="min-h-screen bg-darkColor text-lightColor p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-lightColor/80 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-darkColor/70 rounded-xl p-6 shadow-lg border border-lightColor/10">
            <h2 className="text-2xl font-semibold mb-6 flex items-center gap-2 text-primaryColor-400">
              <FiEdit2 />
              Proposal Details
            </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-darkColor/50 border border-lightColor/10 rounded-lg focus:ring-2 focus:ring-primaryColor-500 focus:border-transparent text-lightColor"
                  />
                </div>
                <div>
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                <button
                  type="submit"
                  disabled={loading}
                  className="flex items-center gap-2 bg-gradient-to-r from-primaryColor-500 to-primaryColor-600 hover:from-primaryColor-600 hover:to-primaryColor-700 text-darkColor px-6 py-3 rounded-lg font-medium shadow-md transition-all disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {loading ? (
                    <>
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-3 border border-lightColor/20 text-lightColor hover:bg-darkColor/50 rounded-lg font-medium"
                >
                  <FiTrash2 />
                  Clear All
                </button>
            ...
            <div className="border-b border-lightColor/10">
              <div className="flex flex-wrap">
                <button
                  ...
                  className={`px-6 py-4 font-medium ${activeTab === "analysis" ? "text-primaryColor-400 border-b-2 border-primaryColor-400" : "text-lightColor/70 hover:text-lightColor"}`}
                >
                  Analysis Report
                </button>
                <button
                  onClick={() => setActiveTab("proposal")}
                  className={`px-6 py-4 font-medium ${activeTab === "proposal" ? "text-primaryColor-400 border-b-2 border-primaryColor-400" : "text-lightColor/70 hover:text-lightColor"}`}
                >
                  Enhanced Proposal
                </button>
              </div>
              ...
              {activeTab === "analysis" ? (
                <div className="space-y-8">
                  <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 p-6 bg-darkColor/50 rounded-lg border border-primaryColor-500/20">
                    <div>
                      <h3 className="text-sm font-medium text-lightColor/80 uppercase tracking-wider mb-2">
                        Overall Score
                      </h3>
                    ...
                    <div className="w-full md:w-64">
                      <div className="flex justify-between text-xs text-lightColor/60 mb-1">
                        <span>0</span>
                        <span>5</span>
                        <span>10</span>
                      </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-darkColor/50 p-6 rounded-lg border border-primaryColor-500/20">
                      <h4 className="font-medium text-xl text-primaryColor-400 flex items-center gap-2 mb-6">
                        Detailed Metrics
                      </h4>
                        ...
                        {Object.entries(result.scores).map(([k, v]) => (
                          <div key={k} className="group">
                            <div className="flex items-center justify-between mb-1">
                              <span className="capitalize text-lightColor font-medium">
                ...
                <div>
                  <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
                    ...
                    <div className="flex gap-3">
                      <button
                        onClick={handleCopy}
                        className="flex items-center gap-2 px-4 py-2 bg-darkColor/50 border border-primaryColor-500/30 hover:bg-primaryColor-500/10 text-lightColor rounded-lg transition-colors"
                      >
                        <FiCopy />
                        {copySuccess || "Copy"}
                      </button>
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-primaryColor-600 hover:bg-primaryColor-700 text-darkColor rounded-lg transition-colors"
                      >
                        <FiDownload />
                        Download
                      </button>
